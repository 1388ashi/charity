...
@section('content')
    <div class="page-header">
        ...
        <a href="{{ route('user.reports.partners-aggregate-cities',$city->id) }}" class="btn btn-outline-info btn-sm"><span class="fa fa-arrow-left"></span></a>
    </div>
    ...
    <x-card>
        ...
        <x-slot name="cardBody">
            <div class="row">
                <form action="{{ route('user.reports.partners-aggregate-list', $city->id) }}" method="GET" class="col-12">
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <a href="{{ route('user.reports.partners-aggregate-list', $city->id) }}" class="btn btn-danger btn-sm btn-block">حذف همه فیلتر ها
        ...
        <x-slot name="cardBody">
            <div class="d-flex justify-content-around">
                <div class="mb-3 d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('user.reports.partners-aggregate-list', $city->id) }}" 
                    ...
                    @foreach ($allStatuses as $statusKey => $statusLabel)
                        ...
                        @endphp
                        <a href="{{ route('user.reports.partners-aggregate-list', ['status' => $statusKey, 'city' => $city->id]) }}"
