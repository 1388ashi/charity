        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div class="card-options ">
                        <a href="{{ route('admin.reports.companions') }}" class="btn btn-outline-info ml-3">مشاهده
                            همه</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <tbody class="text-center">
                                    @forelse($helps as $item)
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $item->companion ? ' شهر: ' . $item->companion->city->name . ' - ' . $item->companion->name : 'آزاد(بدون همیار)' }}</td>
