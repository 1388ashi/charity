...
@section('content')
    ...
    <x-card>
        ...
        <x-slot name="cardBody">
            <div class="row">
                <form action="{{ route('admin.cities.index',$province->id) }}" method="GET" class="col-12">
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                            <a href="{{ route('admin.cities.index',$province->id) }}" class="btn btn-danger btn-block">حذف همه فیلتر ها
