...
@section('content')
    <div class="page-header">
        @php
            $items = [
                        ['title' => 'لیست درخواست ها', 'route_link' => 'admin.partners.index'],
        ...
        {{-- <a   
            target="_blank"
            href="{{ route('admin.partners.print', $partnerGroup->id) }}"   
            class="btn btn-primary btn-sm btn-info">  
            چاپ پرونده
            <i class="fa fa-print"></i>  
        </a>   --}}
        <button type="button" onclick="printDiv('printable-area')"  class="btn btn-primary btn-sm btn-info">
            چاپ پرونده
            <i class="fa fa-print"></i>  
        </button>
    </div>
    <div id="printable-area">
        <h3 class="print-only">چاپ پرونده {{ $partnerGroup->partners[0]->name }}</h3>
        <x-card>
